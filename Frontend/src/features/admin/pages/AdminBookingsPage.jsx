...
import { useAdminBookings } from '../api/useAdminQuery';
...
export default function AdminBookingsPage() {
    ...
    const { data, isLoading, error } = useAdminBookings({ page, limit });
    ...
    return (
        <div className="max-w-6xl mx-auto pb-12">
            <div className="mb-8">
                <h1 className="text-3xl font-bold text-[#04162E] font-serif mb-2">System Bookings</h1>
                <p className="text-[#717378]">Monitor all reservations across the platform.</p>
            </div>
            ...
            {bookings.length === 0 ? (
                <div className="bg-white rounded-xl shadow-sm border border-[#EEEEEE] p-12 text-center">
                    ...
                    <p className="text-[#717378]">There are no reservations in the system yet.</p>
                </div>
            ) : (
                <>
